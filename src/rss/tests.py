...
class RssFeedModelTests(TestCase):
    def setUp(self):
        Feed.objects.create(url='https://djangoproject.com/rss/weblog/')

    def test_model_has_url(self):
        django_feed = Feed.objects.get(url='https://djangoproject.com/rss/weblog/')

        self.assertEqual(django_feed.url, 'https://djangoproject.com/rss/weblog/')

class RssRestFeedsViewTests(TestCase):
    def test_create_feed(self):
        url = 'https://djangoproject.com/rss/weblog/'
